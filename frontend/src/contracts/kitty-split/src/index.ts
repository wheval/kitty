...
export const networks = {
  testnet: {
    ...
    contractId: "CCXLPKQCXVHAYW7UNZWLCAW54NBCGP754OEFGWPUQ5PNJPTREMMXUEHY",
  }
} as const
...
export type DataKey = {tag: "NativeToken", values: void} | {tag: "ReputationContract", values: void} | {tag: "NextId", values: void} | {tag: "Split", values: readonly [u64]};
...
export interface Client {
   ...
   * then reports the payment to the KittyReputation contract.
   */
   ...
   */
  initialize: ({native_token, reputation_contract}: {native_token: string, reputation_contract: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  constructor(options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABAAAAAAAAAAAAAAAC05hdGl2ZVRva2VuAAAAAAAAAAAAAAAAElJlcHV0YXRpb25Db250cmFjdAAAAAAAAAAAAAAAAAAGTmV4dElkAAAAAAABAAAAAAAAAAVTcGxpdAAAAAAAAAEAAAAG",
        ...
        "",
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAgAAAAAAAAAMbmF0aXZlX3Rva2VuAAAAEwAAAAAAAAATcmVwdXRhdGlvbl9jb250cmFjdAAAAAATAAAAAQAAA+kAAAACAAAAAw==",
